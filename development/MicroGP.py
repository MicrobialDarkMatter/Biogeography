    ...
    def model(self, batch):
        ...
        if self.environment:
            ...
            with latents_plate, species_plate:
                w = pyro.sample("w", dist.Normal(loc=w_loc,
...
if __name__ == "__main__":
    ...
    unique_coordinates = dataset.unique_coords[dataset.get_dist_idx_reverse(train_dataset.indices)[0]] if spatial else None
