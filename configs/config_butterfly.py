...
config = {
    "data": {
        "X_path": os.path.join(base_path, "data/butterfly/X_val.csv"),
        "Y_path": os.path.join(base_path, "data/butterfly/Y_val.csv"),
        "coords_path": os.path.join(base_path, "data/butterfly/XY_val.csv"),
        "traits_path": os.path.join(base_path, "data/butterfly/traits.csv"),
        "normalize_X": True,
